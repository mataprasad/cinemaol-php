...
function public_movie_uc_head() { ?>
    <link href="<?php HREF("/content/resources/jquery-ui.css"); ?>" rel="stylesheet" />
    <script src="<?php HREF("/content/Scripts/jquery-ui-1.8.20.js"); ?>"></script>
    <script>
...
function public_movie_uc_body($movie_list) {
    ?>
    ...
    <div style="height: 35px; padding: 0px; margin: 0px; width: 100%; margin-bottom: 15px; display: block; line-height: 35px; vertical-align: middle; text-align: left; color: #FFFFFF; font-size: 15pt; font-weight: bold">
        <div id="radio">
            <input id="hdnNextUrl" type="hidden" value="<?php HREF("/public/movie.php"); ?>">
...
function public_movie_uc_render($movie_list) {
    app_render("public_movie_uc_body", "public_movie_uc_head", null, array($movie_list), array(), array());
}
?>
